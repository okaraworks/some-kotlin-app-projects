...
import static com.example.amaco.utils.Urls.URL_ADD_CART;
...
public class AdapterProducts extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.price.setText(p.getPrice() + " KES");
            ...
            view.img_cart.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (session.isLoggedIn()) {
                        ...
                        Toast.makeText(ctx, "Please login to add items to the cart", Toast.LENGTH_SHORT).show();
                    }
