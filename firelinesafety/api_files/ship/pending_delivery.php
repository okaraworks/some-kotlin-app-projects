...
c2.first_name,c2.last_name FROM booking b INNER JOIN payment p on b.booking_id = p.booking_id
          RIGHT JOIN clients c2 on b.client_id = c2.client_id WHERE b.booking_status='Approved'ORDER BY b.booking_id DESC";
  ...
  if(mysqli_num_rows($query)>0){
      ...
      $results['message']="booking pending approval";
