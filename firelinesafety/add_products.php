...
if(isset($_POST['add_Btn'])){
    ...
    if(empty($product)||empty($imgName)||empty($price)||empty($stock)){
        $swal='error';
...
//                $catID=$row['category_id'];
                ...
                $insert= "INSERT INTO stock(product_name, price, image,stock,capacity) 
                 VALUES ( '$product', '$price', '$image','$stock','$desc')" ;
    ...
    <div class="row">
        <div class="col-md-offset-4 col-md-4">
            ...
            <form method="post"autocomplete="off" enctype="multipart/form-data">
                ...
                <input type="submit" name="add_Btn"value="Add"class="btn btn-info btn-sm">
