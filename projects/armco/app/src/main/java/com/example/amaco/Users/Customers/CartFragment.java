...
import static com.example.amaco.utils.Urls.URL_GET_CART;
...
import com.example.amaco.KAEWA_ADPTS.AdapterCart;
...
public class CartFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        if (session.isLoggedIn()) {
            ...
            txv_success.setText("Please login to view cart");
                            ...
                            if (status.equals("1")) {
                                ...
                                for (int i = 0; i < jsonArray.length(); i++) {
                                    ...
                                    CartModel cartModal = new CartModel(productID, productName, quantity,
                                            price, image, itemID, subTotal, stock, days);
                                    list.add(cartModal);
