...
import static com.example.amaco.utils.Urls.URL_DELIVERY_DETAILS;
import static com.example.amaco.utils.Urls.URL_GET_CHECKOUT_TOTAL;
import static com.example.amaco.utils.Urls.URL_MAKE_PAYMENT;
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (status.equals("1")) {
                                ...
                                txv_order_cost.setText("Booking Ksh " + orderCost);
