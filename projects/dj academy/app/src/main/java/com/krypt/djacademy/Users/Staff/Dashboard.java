...
import com.krypt.djacademy.LoginActivity;
import com.krypt.djacademy.R;
import com.krypt.djacademy.Users.Staff.Driver.Assignment;
import com.krypt.djacademy.Users.Staff.Driver.Issued;
import com.krypt.djacademy.Users.Staff.Driver.ItemsToReturn;
import com.krypt.djacademy.Users.Staff.Driver.MyReturns;
import com.krypt.djacademy.Users.Staff.Driver.Mydeliveries;
import com.krypt.djacademy.Users.Staff.Finance.Approved;
import com.krypt.djacademy.Users.Staff.Finance.FineHistory;
import com.krypt.djacademy.Users.Staff.Finance.NewBookings;
import com.krypt.djacademy.Users.Staff.Finance.NewFines;
import com.krypt.djacademy.Users.Staff.Finance.Rejected;

import com.krypt.djacademy.Users.Staff.Shipping.Delivered;
import com.krypt.djacademy.Users.Staff.Shipping.PendingShipping;
import com.krypt.djacademy.Users.Staff.Shipping.PendingShippingServ;
import com.krypt.djacademy.Users.Staff.Shipping.Shipping;
import com.krypt.djacademy.Users.Staff.Store_man.ConfirmedReturns;
import com.krypt.djacademy.Users.Staff.Store_man.PendingConfirmReturn;
import com.krypt.djacademy.Users.Staff.Store_man.StoreItems;
import com.krypt.djacademy.Users.Staff.Student.UploadActivity;
import com.krypt.djacademy.Users.Staff.Supervisor.BookingFines;
import com.krypt.djacademy.Users.Staff.Supervisor.FeedbackService;
import com.krypt.djacademy.Users.Staff.Supervisor.PendingReturn;
import com.krypt.djacademy.Users.Staff.Supervisor.Returned;
import com.krypt.djacademy.Users.Staff.Supervisor.ShippingBack;
import com.krypt.djacademy.Users.Staff.Supervisor.Technician.Assigned;
import com.krypt.djacademy.Users.Staff.Trainee.Trainee;
...
public class Dashboard extends AppCompatActivity {
    ...
    private void statusLogin() {
        navigationView.getMenu().findItem(R.id.id_tutor_newmixs).setVisible(false);

        navigationView.getMenu().findItem(R.id.id_uploadmix_approved).setVisible(false);
        navigationView.getMenu().findItem(R.id.id_uploadmix).setVisible(false);
...
//            navigationView.getMenu().findItem(R.id.nav_my_returns).setVisible(true);
       ...
       if(user.getUser_type().equals("Event manager")){
        ...
        if(user.getUser_type().equals("Student")){
            navigationView.getMenu().findItem(R.id.id_uploadmix_approved).setVisible(true);
            navigationView.getMenu().findItem(R.id.id_uploadmix).setVisible(true);

        }
        if(user.getUser_type().equals("Tutor")){
            navigationView.getMenu().findItem(R.id.id_tutor_newmixs).setVisible(true);
