package com.example.panafrica.KAEWA_ADPTS;


import static com.example.panafrica.utils.Urls.ROOT_URL_IMAGES;
import static com.example.panafrica.utils.Urls.URL_REMOVE_ITEM;
import static com.example.panafrica.utils.Urls.URL_UPDATE_CART;
...
import com.example.panafrica.KAEWAMODELS.CartModel;
import com.example.panafrica.KAEWAMODELS.ProductModal;
...
public class AdapterCart extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, @SuppressLint("RecyclerView") final int position) {
        if (holder instanceof OriginalViewHolder) {
            ...
            view.txv_days.setText("No of days " + p.getDays());
            view.price.setText(p.getPrice() + " KES par day");
            view.txv_subTotal.setText("Subtotal " + p.getSubToatl() + " KES");
