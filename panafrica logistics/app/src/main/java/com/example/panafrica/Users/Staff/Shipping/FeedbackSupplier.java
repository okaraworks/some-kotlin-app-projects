package com.example.panafrica.Users.Staff.Shipping;
...
import com.example.panafrica.KAEWAMODELS.FeedbackModel;
import com.example.panafrica.KAEWA_ADPTS.AdapterFeedback;
import com.example.panafrica.R;
import com.example.panafrica.utils.SessionHandler;
import com.example.panafrica.utils.Urls;
...
public class FeedbackSupplier extends AppCompatActivity {
...
//
    ...
    public void getFeedback() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Urls.URL_FEEDBACK,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (status.equals("1")) {
                                ...
                                Toast.makeText(FeedbackSupplier.this, msg, Toast.LENGTH_SHORT).show();
                                progressBar.setVisibility(View.GONE);
                            }

                        } catch (Exception e) {
                            e.printStackTrace();
                            Toast.makeText(FeedbackSupplier.this, e.toString(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(FeedbackSupplier.this, error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void send() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, Urls.URL_SEND_FEEDBACK,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
