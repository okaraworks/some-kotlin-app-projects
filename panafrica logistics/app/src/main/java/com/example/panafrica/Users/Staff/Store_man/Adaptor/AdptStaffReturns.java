...
import com.example.panafrica.Users.Staff.Store_man.Model.StaffReturnModel;
import com.example.panafrica.Users.Staff.Store_man.ReturnedItems;
...
public class AdptStaffReturns extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private List<StaffReturnModel> items;
