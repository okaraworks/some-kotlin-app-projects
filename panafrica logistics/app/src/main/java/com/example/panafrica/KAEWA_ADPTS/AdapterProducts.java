...
import static com.example.panafrica.utils.Urls.URL_ADD_CART;
...
//
                            ...
                            days.setError("Enter  numbers of days");
                        } else {
                            dialog.dismiss();
                            progressShow();
                            addToCart();
    ...
    public void addToCart() {
        ...
        final String daysNo = days.getText().toString().trim();
