...
//creating a query
$select = "SELECT s.product_name,s.stock,s.stock_id,s.price,s.image,oi.item_id,oi.quantity,oi.no_of_days FROM stock s 
  INNER JOIN items oi on s.stock_id = oi.stock_id RIGHT JOIN
  booking o on oi.booking_id = o.booking_id WHERE oi.client_id='$clientID' AND o.booking_status='Cart'";
