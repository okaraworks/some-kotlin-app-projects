...
if(isset($_POST['btnReply'])){
    ...
    if(empty($remark)){
        ...
        $update="UPDATE feedback SET feedback='$remark' WHERE fb_id='$hID';";
...
<h3 class="text-center"><span class="semi-bold">Pending feedback</span></h3>
</div>
<div class="row">
<div class="col-md-12">
...
<div class="grid-body no-border">
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tbody>
        <?php
        $select="SELECT * FROM clients c INNER JOIN feedback f on c.client_id = f.client_id
                WHERE  f.feedback=''";
            ...
            <tr class="odd gradeX">
                ...
                <td>
                    ...
                    <a href="#"data-toggle="modal" data-target="#ModalR<?php echo $row['fb_id']?>"
                       class="btn-success btn-sm">Reply</a>
                </td>
            </tr>
            <?php
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-content bg-primary">
                        <form method="post"autocomplete="off">
                            ...
                            <input type="submit" class="btn btn-primary btn-sm form-control" value="Submit" name="btnReply">
                        </form>
