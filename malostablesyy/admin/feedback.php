...
<h3 class="text-center"><span class="semi-bold">Feedback history</span></h3>
</div>
<div class="row">
<div class="col-md-12">
...
<div class="grid-body no-border">
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tbody>
        <?php
        $select="SELECT * FROM clients c INNER JOIN feedback f on c.client_id = f.client_id  WHERE NOT f.feedback=''";
