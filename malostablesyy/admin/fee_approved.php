...
<h3><span class="semi-bold">Fine payment</span></h3>
</div>
<div class="row">
<div class="col-md-12">
...
<div class="grid-body no-border">
    ...
    RIGHT JOIN penalty p on b.booking_id = p.booking_id RIGHT JOIN penalty_pay pp on p.penalty_id = pp.penalty_id
     ORDER BY  pp.pay_id DESC";
        ...
        while($row=mysqli_fetch_array($query)){
            ...
            <tr class="odd gradeX">
                ...
                <td><?php echo $row['penalty_status']?> </td>
            </tr>
            <?php
