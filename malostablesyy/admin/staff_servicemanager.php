...
if(isset($_POST['updateBtn'])){
   ...
   // $role=$_POST['role'];
    ...
    if(empty($firstname) || empty($lastname) || empty($username) ||
        empty($phoneno) || empty($email) ||  empty($password)){
            ...
            if($check=mysqli_num_rows($query)>0){
                ...
                if($check=mysqli_num_rows($query)>0){
                    ...
                    $update="UPDATE employees SET f_name='$firstname',l_name='$lastname',username='$username',
                     contact='$phoneno',email='$email',password='$password' WHERE emp_id='$hID'";
...
<h3><span class="semi-bold">Staff</span></h3>
</div>
<div class="row">
<div class="col-md-12">
...
<div class="grid-body no-border">
    <a href="add_staff.php"class="btn-danger btn-xs btn">Add new service manager</a>
    ...
    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
        ...
        <tbody>
        <?php
        $select="SELECT * FROM employees WHERE userlevel='Service manager'";
        $query=mysqli_query($con,$select);
        while($row=mysqli_fetch_array($query)){
            ...
            <tr class="odd gradeX">
                ...
                <td><a href="#" data-toggle="modal" data-target="#update<?php echo $row['emp_id']?>">Update</a> </td>
            </tr>
            <?php
            ?>
            <!--     ======================================   UPDATE USER ======================================-->
                ...
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Update <?php echo $row['f_name']. ' '.$row['l_name']?></h5>
